                ...
                <Row>
                  ...
                  <Col md='8' xs='7' style={{ textAlign: 'center' }}>
                    <div className='numbers' style={{ paddingTop: '30%' }}>
                      ...
                      <CardTitle tag='p'>{doctorTotaCount}</CardTitle>
                ...
                <Row>
                  ...
                  <Col md='8' xs='7' style={{ textAlign: 'center' }}>
                    <div className='numbers' style={{ paddingTop: '30%' }}>
                      ...
                      <CardTitle tag='p'>{testTotalcount}</CardTitle>
                ...
                <Row>
                  ...
                  <Col md='8' xs='7' style={{ textAlign: 'center' }}>
                    <div className='numbers' style={{ paddingTop: '30%' }}>
                      ...
                      <CardTitle tag='p'>{medicineTotalCount}</CardTitle>
                ...
                <Row>
                  ...
                  <Col md='8' xs='7' style={{ textAlign: 'center' }}>
                    <div className='numbers' style={{ paddingTop: '30%' }}>
                      ...
                      <CardTitle tag='p'>{appointmentTotalCount}</CardTitle>
